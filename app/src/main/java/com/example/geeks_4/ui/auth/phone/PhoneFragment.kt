package com.example.geeks_4.ui.auth.phone
...
class PhoneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.etPhone.setText(codeTelefone)

        binding.btmSend.setOnClickListener {
            sentCode()
        }
    }
